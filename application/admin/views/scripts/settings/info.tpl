<tr>
    <td class="allcontent">{form from=$form}<table>
      <tr>
        ...
        <td class="contentTopRight">E-mail для главной страницы{form_errors_summary}</td>
      </tr>
      <tr>
        <td class="contentCenter"></td>
        <td class="contentCenterLeft">Значение:&nbsp;&nbsp;</td>
        <td class="contentCenterRight rightArea">{form_text name="email_info" style="width:400px;" value=$email_info|escape:html}</td>
      </tr>
      <tr>
        <td></td>
