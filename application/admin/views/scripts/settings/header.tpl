<tr>
    <td class="allcontent">{form from=$form}<table>
      <tr>
        ...
        <td class="contentTopRight">Заголовок сайта поумолчанию{form_errors_summary}</td>
      </tr>
      <tr>
        <td class="contentCenter"></td>
        <td class="contentCenterLeft">Значение:&nbsp;&nbsp;</td>
        <td class="contentCenterRight rightArea">{form_text name="header" style="width:400px;" value=$header|escape:html}</td>
      </tr>
      <tr>
        <td></td>
