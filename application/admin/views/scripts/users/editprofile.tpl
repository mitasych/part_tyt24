        ...
        <div class="pinfo">
            ...
            <div><br />
                ...
                <table>
                    <tr>
                        <td>
                            <p><span class="error_point">*</span>Имя<br />
                                {form_text name="name" value=$user->name|escape}</p>

                            <p><span class="error_point">*</span>Фамилия<br />
                                {form_text name="second_name" value=$user->secondName|escape}</p>

                            <p><span class="error_point">*</span>Отчество<br />
                                {form_text name="third_name" value=$user->thirdName|escape}</p>

                            {*<p><span class="error_point">*</span>Пол<br />
                                {form_select name="gender" options=$genderList selected=$user->gender}</p>*}
                        ...
                        <td style="vertical-align:top;">
                            <div style="margin-left:10px;{if $user->status !=2} display:none;{/if}" id="ur" >
                                <p><span class="error_point">*</span>Наименование организации<br />
                                    {form_text name="organization" id="organization"  value=$user->organization|escape}</p>

                                <p><span class="error_point">*</span>ИНН/ОГРН<br />
                                    {form_text name="innogrn" id="innogrn"  value=$user->innogrn|escape}</p>

                                <p><span class="error_point">*</span>Должность<br />
                                    {form_text name="position" id="position" value=$user->position|escape}</p>

                            </div>

                            <div style="margin-left:10px; {if $user->status !=3} display:none;{/if}" id ="ip">
                                <p><span class="error_point">*</span>ИНН/ОГРН<br />
                                    {form_text name="innogrn2" id="innogrn2"  value=$user->innogrn2|escape}</p>
                    ...
                    <tr><td>
                            ...
                            {form_text name="email" value=$user->email|escape}
                        </td>
                        <td><div style="margin-left:10px;">Телефон/Факс<br />
                                {form_text name="phone" value=$user->phone|escape}</div></td>
                    </tr>
                </table>
            </div>
            <div class="dotted">  <br></div>
                ...
                <div id="vnf" {if $fparams.status ==1}style="display:none;"{/if}>
                    ...
                    <div id="dog" {if !$user->dogovorNotifyFlag}style=" display:none;"{/if} >
                         <p><span class="error_point">*</span>Должность руководителя <br>
                            {form_text name="dolj" id="dolj" value=$user->dolj|escape}, в родительном падеже :
                            {form_text name="doljr" id="doljr" value=$user->doljr|escape}
                        </p>

                        <p><span class="error_point">*</span>Фамилия <br>
                            {form_text name="df" id="df" value=$user->df|escape}, в родительном падеже :
                            {form_text name="dfr" id="dfr" value=$user->dfr|escape}</p>

                        <p><span class="error_point">*</span>Имя <br>
                            {form_text name="di" id="di" value=$user->di|escape}, в родительном падеже :
                            {form_text name="dir" id="dir" value=$user->dir|escape}</p>

                        <p><span class="error_point">*</span>Отчество <br>
                            {form_text name="do" id="do" value=$user->do|escape}, в родительном падеже :
                            {form_text name="dor" id="dor" value=$user->dor|escape}</p>
                        ...
                        <p><span class="error_point">*</span>Действующий
                            ...
                            {form_text name="dot" id="dot" value=$user->dot|escape}</p>
                ...
                <div id="anf" {if $fparams.status ==1}style="display:none;"{/if}>
                     ...
                     <div id="em" {*if !$user->aktNotifyFlag}style=" display:none;"{/if*} ><br>
                        <p><span class="error_point">*</span>Адрес для отправки актов<br />
                            {form_text name="akt_email" id="akt_email" value=$user->akt_email|escape style="width:450px"}</p>
                    </div>
                </div>

           
            Источник информации о нас:<br>{form_select name="from" options=$fromList selected=$user->from}<br><br>
            Профиль компании:<br>{form_text name="companyProfile" id="companyProfile" value=$user->companyProfile|escape}
            ...
            <table>
                <tr><td>
                        ...
                        {form_password name="newpass"}
                    </td>
                    <td><div style="margin-left:10px;">Подтверждение нового пароля<br />
                            {form_password name="newpassc"}</div></td>
                </tr>
