...
$list->addWhere('A.is_deleted = 0 AND EXISTS (SELECT B.user_id from orders_relations AS B WHERE B.user_id = A.id)');

$lister = new AK_Data_Lister($list, $this->getRequest(), 'ausers');
...
$lister->PARAM_SCRIPT = MODULE_URL.'/orders/ausers.list/';
