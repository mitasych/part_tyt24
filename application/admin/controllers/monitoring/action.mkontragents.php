<?php
$list = new AK_Order_Kontragent_List();
$list->setActual(true);
$lister = new AK_Data_Lister($list, $this->getRequest(), 'mkontragents');
...
$_option->setTEXT_LABEL('<font color=blue>Добавить событие</font>')->setLINK_CLASS('tableBottomNext')->setLINK_HREF(MODULE_URL.'/monitoring/eventedit/a/mkontragents/idaskid/1/');
$lister->addOption($_option);

$_option = new AK_Data_Lister_Option();
$_option->setTEXT_LABEL('<img src="/admin/images/edit.png" />')->setLINK_CLASS('tableBottomNext')->setLINK_HREF(MODULE_URL.'/monitoring/kontragentedit/a/mkontragents/');
$lister->addOption($_option);


$_option = new AK_Data_Lister_Option();
$_option->setTEXT_LABEL('<img src="/admin/images/bascket.png" />')->setLINK_CLASS('tableBottomRight')->setLINK_HREF(MODULE_URL.'/monitoring/kontragentdelete/a/mkontragents/')->setLINK_EVENT('onclick = "return confirm(\'Удалить ?\');"');
$lister->addOption($_option);

$_toplink = new AK_Data_Lister_TopLink();
$_toplink->setTEXT_LABEL('Добавить')->setTEXT_STRONG(false)->setLINK_HREF(MODULE_URL.'/monitoring/kontragentedit/a/mkontragents/');
