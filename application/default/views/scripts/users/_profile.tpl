...
<div>
    <div class="main_top_text">
       ...
       {* {include file="lmenu.tpl"} *}
          <div>
             <span style="color:red;font-weight:bold;font-size:14px;">СЕРВИСЫ:</span> <span style="float:right;color:red;font-weight:bold;"> Баланс <span style="color:#2D96FE;">{$user->balans} руб.</span> <a href="{$SITE_URL}/order/balans/" style="text-decoration:underline;color:red;font-weight:bold;">пополнить</a> </span>
            </div>  
