...
<td style='vertical-align: top;'>
	{if $level > 1}
		...
		<a href='{$SITE_URL}/database/index/id/{$db_parent}/'>{$db_parent_name}</a>
	{/if}
...
<td style='vertical-align: top;'>
	{if $level < 3}
		...
		{foreach from=$subrubric_list item=subrubric}
			<tr>
			<td><a href='{$SITE_URL}/database/index/id/{$subrubric.id}/'>{$subrubric.name} ({$subrubric.c_all})</a></td>
...
<td colspan='2' style='padding-top: 15px; vertical-align: top;'>
	...
	{foreach from=$rubric_list item=rubric}
		<tr>
		<td><a href='{$SITE_URL}/database/index/id/{$rubric.id}/'>{$rubric.name}</a></td>
		<td>
