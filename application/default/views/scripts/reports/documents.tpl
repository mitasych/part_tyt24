    ...
    <div class="main_top_text">
        ...
        <div>
            ...
            <p>
                ...
                {form_checkbox name="vipiska_notify_flag" value="1" style="margin:0;padding:0;"} Получать копию выписки на e-mail<br>
                <br>
        ...
        {form_checkbox name="akt_notify_flag_report" value="1" style="margin:0;padding:0;"} Получать акты оказанных услуг
