		...
		<table cellpadding="0" cellspacing="0" border="0" width="100%">
			<tr>
				<td class="branch_li">
                                                <h1 class="categorys"><a href="{$SITE_URL}/index/index/okato/{$okato}">РУБРИКИ</a><a id="rub" style="font-size:16px;" href="{$SITE_URL}/index/index/okato/{$okato}/sort/1/id/{$id}/">(А-Я)</a></h1>
                                               <div class="branch_submenu">
                                             <p>ТОП: <a href="{$SITE_URL}/index/index/okved/{$okvedtop.id}/okato/{$okato}/">{$okvedtop.name} ({$okvedtop.count}) </a></p>
...
<a {if $hit==$id} class="selected" {/if}  href="{$SITE_URL}/index/rubric/id/{$hit}/">{$hit}</a>
{/foreach}
					...
					<ul class="brunch a-b">
						...
						<li class="head"><a href="{$SITE_URL}/index/index/okved/{$hit.id}/okato/{$okato}/">{$hit.name} ({$hit.count})</a></li>
				...
				<td class="region_li">
					<h1><a href="{$SITE_URL}/index/rubric/id/*/">Регионы</a><a id="rub" style="font-size:16px;"></a></h1>
                                        <div class="branch_submenu">
                                          <p>ТОП: <a href="{$SITE_URL}/index/index/okved/{$okved}/okato/12530/">Москва</a> <a href="{$SITE_URL}/index/index/okved/{$okved}/okato/11600/">Санкт-Петербург</a> <a class="li_ico">&nbsp;&nbsp;&nbsp;&nbsp;</a></p>
					...
					{*	<p>ТОП: <a href="#">Москва (175)</a> <a href="#" class="li_ico">&nbsp;&nbsp;&nbsp;&nbsp;</a></p> *}
						...
						<li>
                                                   <a href="{$SITE_URL}/index/rubric/id/{$id}/okato/{$current.id} /">{$current.name} </a>
                                                   <ul>
                                                   {foreach from=$current.subitems item=subitem key=key }
                                                        <li>
                                                            <a href="{$SITE_URL}/index/rubric/id/{$id}/okato/{$key}/">{$current.type}{$subitem} </a>
                                                        </li><br/>
                                                   {/foreach}
