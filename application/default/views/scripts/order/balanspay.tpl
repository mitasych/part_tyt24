<div class="right_part2">
    ...
    <div>
        <div class="main_top_text">
            ...
            {breadcrumb controller="info" alias="orderBasket" title='' altTitle="Оплата баланса"}

            <h1>Оплата баланса</h1>

            <p><b>№ заказа/счета: </b>{if $orderItem->number}{$orderItem->number}{else}{$orderItem->secretCode}{/if}
            </p>
			{assign var=hide_pay value=yes} 	
...
{/foreach}
			...
			<table><tr><td valign="top" width="300" class="my_orders">
