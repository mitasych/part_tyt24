...
<div class="company_page">
	...
	{*foreach from=$pricesOutput key=pid item=phtml}
        <div style="display:block;" id="priceBoxHidden{$pid}">{$phtml}</div>
        {/foreach*}
        
                  <li class="o1" title='{$pricesOutput[2]}'><a href='{$SITE_URL}/info/check/fastmode/true/id/{$id}/add1/2/isfiz/0/' >заказать<br /> выписку из ЕГРЮЛ</a></li>
						<li class="o4" title='{$pricesOutput[7]}'><a href='{$SITE_URL}/info/check/fastmode/true/id/{$id}/add1/7/'>заказать<br />БУХГАЛТЕРСКИЙ БАЛАНС</a></li>
						<li class="o3" title='в разработке'><a href="#">заказать<br /> ФИНАНСОВЫЙ АНАЛИЗ</a></li>
						<li class="o2" title='{$pricesOutput[4]}'><a href='{$SITE_URL}/info/check/fastmode/true/id/{$id}/add1/4/'>заказать<br />БИЗНЕС СПРАВКУ</a></li>
                  <li class="o5" title='{$pricesOutput[5]}'><a href='{$SITE_URL}/info/check/fastmode/true/id/{$id}/add1/5/'>заказать<br />БИЗНЕС СПРАВКУ ВЭД</a></li>
