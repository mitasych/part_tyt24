...
$form->addRule('money', 'required', 'Выберите способ оплаты 1');

//$form->addRule('priority', 'required', 'Выберите приоритет');

if ($form->isPostBack()) {

    if (empty($this->params['money']) && $this->params['money']!="" && $this->params['money']!="0") {
        $form->addRule('money1', 'required',  'Выберите способ оплаты 2');
    }
