...
class AK_Order_Monitoring_Event_List extends AK_Order_Abstract_List {
    ...
    public function getList() {
        ...
        if ( $this->isAsAssoc() ) {
            ...
            $query->from('orders_monitoring__events AS A', $fields);
        }
        else {
            $query->from('orders_monitoring__events AS A', 'A.*');
        }
